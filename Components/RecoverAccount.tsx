    ...
    <div className='bg-green-700 flex flex-col px-6 py-8 items-center justify-center h-screen'>
      ...
      shadow border sm:max-w-md  border-green-500   ">
        <div className='flex flex-col md:space-y-6 sm:p-8 '> 
          ...
          <form action="">
         <div>
            <label htmlFor="">Insira o código que enviamos por email</label>
            <input type="text" className='rounded-lg w-full text-white border border-green-500 bg-green-600 placeholder:text-slate-200 placeholder:p-1 p-1.5' placeholder='0 0 0 - 0 0 0'></input>
         </div>
         <Link href="/login">
