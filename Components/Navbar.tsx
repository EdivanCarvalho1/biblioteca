...
<nav className="bg-gradient-to-r from-dark:emerald-500 to-emerald-800
dark:bg-green-700">
  ...
  <div className="flex md:order-2">
    ...
    className="md:hidden text-green-500 dark:text-green-400
    ...
    <div className="relative hidden md:block">
      ...
      <input type="text" id="search-navbar" className="block w-full p-2 ps-10 text-sm text-gray-900 border 
      rounded-lg dark:border-gray-600 " placeholder="Procurar..."/>
    </div>
    <button data-collapse-toggle="navbar-search" 
    type="button" className="inline-flex items-center p-2 w-10 h-10 
    justify-center text-sm text-gray-500 rounded-lg md:hidden
     hover:bg-gray-100 focus:outline-none focus:ring-2
     focus:ring-gray-200 dark:text-green-400
     dark:hover:bg-cyan-50 dark:focus:ring-emerald-600" 
     aria-controls="navbar-search" aria-expanded="false">
    ...
    md:flex md:w-auto md:order-1" id="navbar-search">
      <div className="relative mt-3 md:hidden">
        ...
        <input type="text" id="search-navbar" className="block w-full p-2 ps-10 text-sm
      ...
      rounded-lg 
        ...
        bg-green-700 
         ">
        <li className="p-1">
          <a href="#" className="block  text-white md:p-1 rounded-lg hover:bg-green-800
          px-8 py-4 transition-colors duration-300" 
          aria-current="page">Início</a>
        </li>
        <li className="p-1">
          <a href="#" className="block py-2  text-white rounded-lg
           hover:bg-green-800 px-4 transition-colors duration-500
           md:p-1">
            Sobre</a>
        </li>
        <li className="p-1">
          <Link href="/login"
          className="block py-2  text-white rounded-lg  hover:bg-green-800 
